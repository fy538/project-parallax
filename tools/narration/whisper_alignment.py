...
def _cache_key(
    wav_path: Path, model_size: str, language: str | None, compute_type: str,
) -> str:
...
def _cache_load(key: str) -> Transcript | None:
...
def find_low_confidence_spans(
    ...
    beat_lookup_at_time: dict[float, int] | None = None,
) -> list[AlignmentIssue]:
    ...
    issues: list[AlignmentIssue] = []
    in_span = False
    span_start: TranscriptWord | None = None
...
def render_diff_md(report: AlignmentReport, slug: str) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        "> Auto-generated by `tools/narration/whisper_alignment.py`. **Do not edit.**",
        "> Compares the production script against the Whisper transcript of the recording.",
        "",
