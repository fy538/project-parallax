...
def check_takes_share_script(takes: list[TakeMetrics]) -> str | None:
...
def render_comparison_md(
    ...
    lines: list[str] = [
        ...
        "",
        "> Auto-generated by `tools/narration/take_selector.py`. **Do not edit.**",
...
def _resolve_take_name(path: Path, custom: str | None, index: int) -> str:
    if custom:
        return custom
