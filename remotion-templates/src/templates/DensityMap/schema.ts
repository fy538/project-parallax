...
export const DensityModeSchema = z.enum(["hex", "heatmap", "grid"]);

export const DensityPhaseSchema = z.object({
  title: z.string(),
...
export const DensityMapDataSchema = z.object({
  episode: z.string(),
  title: z.string(),
  subtitle: z.string().optional(),
  ...
  mode: DensityModeSchema.optional(),
