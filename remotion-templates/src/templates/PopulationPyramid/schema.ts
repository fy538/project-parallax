...
export const PyramidCohortSchema = z.object({
...
export const PyrSideSchema = z.object({
  label: z.string(),
  cohorts: z.array(PyramidCohortSchema),
  color: z.string().optional(),
});

export const PopulationPyramidDataSchema = z.object({
  episode: z.string(),
...
export const PopulationPyramidSchema = z.object({
  data: PopulationPyramidDataSchema,
});
