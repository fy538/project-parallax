...
- **Cross-reference with lint.** If `npm run lint:tsx` (tools/lint/polish_lint.py) found violations in a template, mention whether those violations are visually apparent in the render.
