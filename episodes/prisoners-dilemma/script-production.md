...
**Script version:** v5 (psychology audit — cold open 4-beat restructure, structural markers, [FORECAST:] conversion, confidence boundary)
...
| In January 1950, two researchers at the RAND Corporation ran the first-ever prisoner's dilemma experiment. {✅} | **P3** · [AI-GEN:] "1950s California research office, two men in shirtsleeves at a small table with paper grids, warm afternoon light through venetian blinds, planar-faceted faces obscured by shadow, color-blocked mid-century interior" · static establishing · kling-3.0 · standard · 7s |
|  | DIR: cam(static) |
...
| John Nash — the man whose equilibrium concept the experiment was testing — read the results. {✅} His response wasn't to question the model. It was to question the players. | **P2** · [FOOTAGE:] "1950s academic portrait black and white" > "vintage mathematician portrait" · Wikimedia · standard · 5s |
|  | DIR: mood(subtle, dim:0.3) |
| He said they would have been "more rational" if they'd been prevented from seeing each other. {✅} | **P1** · [MG:] KineticTypography — Quote: "I would have thought them more rational." — John Nash, 1950 · bone text on ink · 5s hold |
|  | DIR: hold(land) |
| *[Beat.]* | |
| That response — blame the players, not the model — set a template. The most influential framework in strategic thinking was contradicted by its own first experiment. It conquered the world anyway. | **P2** · [ILLUST:] metaphor · "Constructivist propaganda poster: a mathematical equation radiating outward like sunbeams over silhouetted institutions — university, military headquarters, stock exchange — all turning toward the equation as if worshipping it" · vector_illustration · standard · 7s |
...
| The standard story is that the Prisoner's Dilemma explains why cooperation between nations is so hard. That it reveals a deep truth about rational self-interest. | **P3** · [FOOTAGE:] "aerial view of international summit building" > "diplomatic conference exterior" · Pexels · standard · 6s |
...
| How? Because of where it was born. | **P2** · [FOOTAGE:] "RAND Corporation building 1950s" > "mid-century modern office building California" · Wikimedia/Pexels · standard · 5s |
| Not a university. Not a think tank the way we use the word now. RAND Corporation — a defense contractor for *ideas*, funded by the Air Force, staffed with mathematicians, tasked with one job: making nuclear war thinkable. {✅} | **P2** · [AI-GEN:] "Wide shot of a 1950s institutional corridor, fluorescent lighting, planar-faceted figure in suit walking past chalkboards covered in game matrices, color-blocked walls in grey-green and cream, mannequin face obscured by angle" · slow forward dolly · kling-3.0 · standard · 7s |
...
| And then it escaped the building. | **P3** · [FOOTAGE:] "office door opening to sunlight" > "doorway opening bright" · Pexels · standard · 3s |
| | PACE: urgent |
...
| In the Prisoner's Dilemma, mutual cooperation is not an equilibrium. Defection always pays more. In the stag hunt, mutual cooperation *is* an equilibrium — it's rational to cooperate, as long as you can trust that others will too. The puzzle shifts from domination to coordination. | **P1** · [MG:] GameBoard — Side-by-side: PD matrix (one dot at mutual defection) vs. Stag Hunt (two dots, cooperative dot highlighted amber). · [prisoners-dilemma/gameboard-pd-vs-staghunt.json] · 10s |
...
| *[Beat.]* | |
| And we don't have to theorize. Elinor Ostrom spent thirty years documenting communities that solved this problem in practice. {✅} | **P3** · [FOOTAGE:] "traditional farming terraced fields" > "rural landscape agriculture" · Pexels · standard · 5s |
|  | DIR: mood(subtle) |
...
| | PACE: breathing |
| So what does this change? | **P3** · [FOOTAGE:] "city street crowd walking evening" > "urban street pedestrians" · Pexels · standard · 4s |
|  | DIR: mood(subtle, drift:slow) |
...
| | PACE: breathing |
| Games can be changed. It's not easy — seventy-five years of institutional momentum is real. The textbooks are written. The career incentives reward people who think in these terms. | **P3** · [FOOTAGE:] "university lecture hall students" > "academic classroom" · Pexels · standard · 5s |
|  | DIR: mood(subtle) |
| But it has been done before. In 1986, Reagan and Gorbachev walked into a summit that their entire strategic establishment had coded as a Prisoner's Dilemma. {⚠️} Two nuclear powers. Rational defection. Zero-sum logic. And they reframed it. Not as naive trust — as coordination. Common security. The result was the INF Treaty, which eliminated an entire class of nuclear weapons. | **P2** · [FOOTAGE:] "Reagan Gorbachev summit handshake" > "Cold War diplomacy summit" · Wikimedia · standard · 6s |
|  | DIR: hold(breathe) |
| What the evidence establishes: the stag hunt was always available, cooperation is designed rather than miraculous, and the framing we use shapes the game we get. What it can't establish: whether reframing alone shifts outcomes without the institutional scaffolding Ostrom documents — boundaries, monitoring, graduated sanctions. The framing is necessary. It may not be sufficient. | **P2** · [MG:] KineticTypography — "What the evidence establishes / What it can't establish" — two-column, bone text, amber headers · 7s |
|  | DIR: hold(breathe) |
...
|  | DIR: reveal(instant) |
|  | DIR: mood(subtle) |
| Seventy-five years later, the model that couldn't predict two people in a room is shaping how entire civilizations negotiate their shared future. | **P3** · [ILLUST:] illustration · "Constructivist panorama: two vast geometric cityscapes facing each other across a narrow channel, the channel itself shaped like a game theory matrix, tiny mannequin figures standing at the edges looking across, amber light from below, ink sky above" · vector_illustration · conflict · 7s |
|  | DIR: mood(dense, dim:0.4) |
|  | DIR: hold(linger) |
|  | DIR: cut(dissolve) |
| Now you can see it. The question is what you do with that. | **P1** · [MG:] GameBoard — Final frame: two equilibrium dots side by side. One amber (cooperation). One grey (defection). Both available. · [prisoners-dilemma/gameboard-final-choice.json] · 5s hold |
|  | DIR: reveal(stagger:500ms, glow) |
|  | DIR: mood(none, drift:none) |
|  | DIR: hold(linger) |
| *(Voice note: end quiet. No flourish. Let the image hold.)* | |

**Beat 5 word count:** ~590 words · **Est. runtime:** ~2:30
...
| [FOOTAGE:] | 12 | ~3:50 | ~21% | — |
| [ILLUST:] | 3 | ~0:21 | ~6% | Atmospheric |
| [AI-GEN:] | 3 | ~0:21 | ~6% | Grounding |
| [LAYERED:] | 0 | — | 0% | Mixed |
| TRANSITION | 4 | ~0:08 | ~2% | — |

Target ranges: MG 40-55% ✅, FOOTAGE 25-40% ⚠️ (slightly low — Philosopher's Lens format is inherently MG-heavy), ILLUST 5-15% ✅, AI-GEN 5-15% ✅, LAYERED 5-10% ⚠️ (none — consider adding 1-2 in revision).
All three registers (Analytical, Atmospheric, Grounding) are present. ✅

### Direction Summary
| Metric | Count |
|--------|-------|
| Segments with DIR: lines | 22/~45 total (~49%) |
| Total DIR: lines | ~55 |
| Narration sync points | 8 |
| Register transitions with explicit cut() | 4/4 |
| PACE: annotations | 7 (across 4 structural shifts) |

⚠️ Direction density is slightly above target (~25% segments recommended, we have ~49%). Some P2/P3 entries have direction that could use template defaults. Consider trimming mood() on P3 footage entries.
...
| 14 | DataChart | Black-Scholes volatility smile | chart-vol-smile.json | [MG:] |
...
| 20 | GameBoard | PD vs. stag hunt side-by-side | gameboard-pd-vs-staghunt.json | [MG:] |
...
|---|----------|-------------|---------|-----------|----------|-------------|
| 1 | P2 | "1950s academic portrait black and white" > "vintage mathematician portrait" | Wikimedia | standard | 5s | Moderate |
| 2 | P2 | "RAND Corporation building 1950s" > "mid-century modern office building California" | Wikimedia/Pexels | standard | 5s | Moderate |
| 3 | P3 | "office door opening to sunlight" > "doorway opening bright" | Pexels | standard | 3s | Easy |
| 4 | P3 | "oil refinery industrial sunset" > "petroleum infrastructure" | Pexels | standard | 6s | Easy |
| 5 | P3 | "forest canopy morning light" > "woodland dawn atmosphere" | Pexels | standard | 5s | Easy |
| 6 | P3 | "traditional farming terraced fields" > "rural landscape agriculture" | Pexels | standard | 5s | Easy |
| 7 | P3 | "ocean aerial vastness" > "open ocean horizon wide" | Pexels | standard | 6s | Easy |
| 8 | P3 | "city street crowd walking evening" > "urban street pedestrians" | Pexels | standard | 4s | Easy |
| 9 | P3 | "university lecture hall students" > "academic classroom" | Pexels | standard | 5s | Easy |
| 10 | P2 | "Reagan Gorbachev summit handshake" > "Cold War diplomacy summit" | Wikimedia | standard | 6s | Moderate — accept still |
| 11 | P3 | "earth from space" > "globe earth overview" | Pexels | standard | 5s | Easy |

### Images / Archival
| # | Priority | Description | Source | Treatment |
|---|----------|-------------|--------|-----------|
| 1 | P2 | Reagan-Gorbachev summit photo (INF Treaty era) | Wikimedia Commons | standard |

### Atmospheric Illustrations (Recraft — Register 2)
| # | Mode | Prompt | Style | Treatment | Use |
|---|------|--------|-------|-----------|-----|
| 1 | metaphor | "Constructivist propaganda poster: mathematical equation radiating sunbeams over silhouetted institutions" | vector_illustration | standard | Beat 1 — model conquering the world |
| 2 | metaphor | "Constructivist grid projected from spotlight onto landscape, landscape reshaping to match grid" | vector_illustration | standard | Beat 3 — model remaking reality |
| 3 | illustration | "Constructivist sunrise: geometric rays through angular clouds, cooperative figures below" | vector_illustration | standard | Beat 4 — relief / alternative exists |
| 4 | illustration | "Constructivist panorama: two cityscapes facing across game-matrix channel, mannequin figures at edges" | vector_illustration | conflict | Beat 5 — civilizations negotiating |

### AI-Generated Video (Register 3)
| # | Scene | Camera | Style-Ref | Tool | Treatment | Duration |
|---|-------|--------|-----------|------|-----------|----------|
| 1 | "1950s research office, two men at table with paper grids, venetian blind light" | static | midcentury-warm_v1.png | kling-3.0 | standard | 7s |
| 2 | "1950s institutional corridor, figure walking past chalkboards with game matrices" | slow forward dolly | midcentury-warm_v1.png | kling-3.0 | standard | 7s |
| 3 | "Two figures entering stark negotiation room from opposite doors, geometric shadows" | slow pull-back | negotiation-cold_v1.png | kling-3.0 | standard | 7s |

---

## PRODUCTION NOTES

**Total narration word count:** ~2,760 (v5 — adds ~140 words: 4-beat opener + confidence boundary)
...
**Psychology audit (Lens 9) — v5 fixes applied:**
...
**Three registers:** Analytical (MG: 46%), Atmospheric (ILLUST: 6%), Grounding (AI-GEN: 6%) ✅
**Register transitions:** AI-GEN→MG (color-wash, ink), ILLUST→MG (iris, origin:center), MG→ILLUST (dissolve) ✅
**Direction density:** ~55 DIR: lines across ~22 segments — slightly over target. Trim P2/P3 mood() directives in revision.
